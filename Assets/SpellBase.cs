...
public class SpellBase : MonoBehaviour {
    ...
    public virtual void Execute(Spell thisSpell, Character caster)//<spellbase>.Execute() calls the behaviour of the spell base, such as creating a projectile and checking if it hits any enemies
